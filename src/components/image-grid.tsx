...
export const LayoutGrid = ({ cards }: { cards: Card[] }) => {
  ...
  return (
    <div className="relative mx-auto grid h-full w-full max-w-7xl  grid-cols-1 gap-4 md:grid-cols-2">
      {cards.map((card) => (
      ...
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-0 z-10 h-full w-full bg-white backdrop-blur-md",
